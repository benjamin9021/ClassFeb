...
public class BoardDAO {
	...
	public void update(BoardDTO dto) {
		   ...
		   String sql = "update board set author= ?,title= ? ,content= ? where num =? ";
		   try {
		      conn = dataFactory.getConnection();
	...
	public PageTO list(int curPage) {
		...
		String sql ="select * from ("
				+ "select rownum rnum, num, title,"
				+ "author, to_char(writeday, 'yyyy/mm/dd') writeday,"
				+ "readcnt, repIndent from ("
				+ "select * from board order by repRoot desc, repStep asc)) where rnum between ? and ?";
		ResultSet rs = null; 
